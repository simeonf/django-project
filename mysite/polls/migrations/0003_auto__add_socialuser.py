...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('polls_socialuser', (
            ...
            ('g_plus', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('polls', ['SocialUser'])


    def backwards(self, orm):
        # Deleting model 'SocialUser'
        db.delete_table('polls_socialuser')
    ...
    models = {
        ...
        'polls.socialuser': {
            ...
            'g_plus': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
